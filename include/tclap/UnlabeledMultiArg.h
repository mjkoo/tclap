...
public:
     ...
     */
    UnlabeledMultiArg(const std::string& name, const std::string& desc, bool req, const std::string& typeDesc,
     ...
     * use this unless you have a very good reason.
     */
    UnlabeledMultiArg(const std::string& name, const std::string& desc, bool req, Constraint<T>* constraint,
        bool ignoreable = false, Visitor* v = NULL);
     ...
     * \param i - The current argument in the list.
     * \param args - Mutable list of strings. Passed from main().
     */
    virtual bool processArg(std::size_t* i, std::vector<std::string>& args);
...
template <class T>
UnlabeledMultiArg<T>::UnlabeledMultiArg(const std::string& name, const std::string& desc, bool req,
    const std::string& typeDesc, bool ignoreable, Visitor* v)
...
template <class T>
UnlabeledMultiArg<T>::UnlabeledMultiArg(const std::string& name, const std::string& desc, bool req,
    const std::string& typeDesc, CmdLineInterface& parser, bool ignoreable, Visitor* v)
  : MultiArg<T>("", name, desc, req, typeDesc, v)
{
    _ignoreable = ignoreable;
    OptionalUnlabeledTracker::check(true, toString());
...
template <class T>
UnlabeledMultiArg<T>::UnlabeledMultiArg(
    const std::string& name, const std::string& desc, bool req, Constraint<T>* constraint, bool ignoreable, Visitor* v)
...
template <class T>
UnlabeledMultiArg<T>::UnlabeledMultiArg(const std::string& name, const std::string& desc, bool req,
    Constraint<T>* constraint, CmdLineInterface& parser, bool ignoreable, Visitor* v)
  : MultiArg<T>("", name, desc, req, constraint, v)
{
    _ignoreable = ignoreable;
    OptionalUnlabeledTracker::check(true, toString());
