...
protected:
     ...
     */
    Arg(const std::string& flag, const std::string& name, const std::string& desc, bool req, bool valreq,
        Visitor* v = NULL);
...
public:
     ...
     */
    static char blankChar() { return '\x07'; }
 ...
 */
template <typename T>
void ExtractValue(T& destVal, const std::string& strVal, StringLike)
{
...
inline Arg::Arg(
    const std::string& flag, const std::string& name, const std::string& desc, bool req, bool valreq, Visitor* v)
  : _flag(flag)
  , _name(name)
  , _description(desc)
  , _required(req)
  ...
  , _acceptsMultipleValues(false)
{
    ...
    if (_name != ignoreNameString()
        ...
        throw(SpecificationException("Argument flag cannot be either '" + Arg::flagStartString() + "' or '"
    ...
    if ((_name.substr(0, Arg::flagStartString().length()) == Arg::flagStartString())
        ...
        throw(SpecificationException("Argument name begin with either '" + Arg::flagStartString() + "' or '"
