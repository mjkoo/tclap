...
public:
     ...
     */
    UnlabeledValueArg(const std::string& name, const std::string& desc, bool req, T value, const std::string& typeDesc,
     ...
     * you have a very good reason.
     */
    UnlabeledValueArg(const std::string& name, const std::string& desc, bool req, T value, Constraint<T>* constraint,
        bool ignoreable = false, Visitor* v = NULL);
 ...
 */
template <class T>
UnlabeledValueArg<T>::UnlabeledValueArg(const std::string& name, const std::string& desc, bool req, T val,
...
template <class T>
UnlabeledValueArg<T>::UnlabeledValueArg(const std::string& name, const std::string& desc, bool req, T val,
    Constraint<T>* constraint, bool ignoreable, Visitor* v)
